	...
	<body>
		...
		<header class="header">
						...
						<div id="menu" class="buttons">
							...
							<div class="button"><a href="o_nas.html">O nas</a></div>
						</div>
					...
					<div id="here2" class="tor">
						...
						<div id="logowanie">
							...
							<form id="register" method="POST" action="login.php">
								<h2>Logowanie:</h2><br />
								Login: <input type="text" id="nick" name="login" maxlength="14" autocomplete="off" required=""><br />
								Hasło: <input type="password" id="pass" name="haslo" maxlength="20" autocomplete="off" required=""><br />
